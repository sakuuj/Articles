...
public class KafkaConfig {
    ...
    public NewTopic articlesTopics(
            @Value("${by.sakuuj.articles.article.kafka.topic-name}") String topicName,
            @Value("${by.sakuuj.articles.article.kafka.replicas}") int replicas,
            @Value("${by.sakuuj.articles.article.kafka.partitions}") int partitions
            ) {
